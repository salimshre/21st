...
App.Habits = (function(){
  ...
  function emptyDay(){
    ...
    return { h:h, po:po, rb:rb, rating:5, journal:"", priority:"", saved:false };
  }
  ...
  function updateDailyStats(){
    ...
    var pct = Math.round((hc/HABITS.length*0.4 + rc/ROUTINE_BLOCKS.length*0.35 + Math.min(totalP/targetP,1)*0.25) * 100);
